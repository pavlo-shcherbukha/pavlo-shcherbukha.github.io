...
Особливо контейнери з базами даних дуже полюбляють писати багато логів. Якщо контейнер колись працював довго, його лог-файл міг розростися до кількох гігабайт.
...
- Розширити розділ (зазвичай це /dev/sda та розділ 1, 2 або 3 — перевірте через lsblk):
...
- Рестартувати віртуальну машину.
