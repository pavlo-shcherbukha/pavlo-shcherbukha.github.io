...
- [Про що цей блог](#p-0")
- [X] [1. AZ-204: Implement Azure App Service web apps](#p-1)
- [X] [2. AZ-204: Implement Azure Functions](#p2)
- [X] [3. AZ-204: Develop solutions that use Blob storage](#p3)
...
- [X] [8 AZ-204: Implement API Managemen](#p8)
- [X] [9. AZ-204: Develop event-based solutions](#p9)
- [X] [10. AZ-204: Develop message-based solutions](#p10)
- [X] [11. AZ-204: Develop message-based solutions](#p11)
...
В цьому репозиторії зібрані практичні навички ( розроблено декілька прототипів) з розробки так би мовити "класичних" azure functions. 
[Власний досвід вичення azure functions](https://github.com/pavlo-shcherbukha/az-204-funcs/blob/main/README.md)
