...
Давайте розберемо це на реальному прикладі: побудові системи моніторингу для  фармацевтичного чи продуктового холодильника та створенні прототипу Цифрового двіника в Microsoft Fabric, але дуже маленького. Так як це прототип, то холодильник думашній, датчик температури теж "домашній" DHT22. Тому тут не розглядаємо якесь промислове рішення і не боремося з точнісю. Тут більше розглядається концепція. 
