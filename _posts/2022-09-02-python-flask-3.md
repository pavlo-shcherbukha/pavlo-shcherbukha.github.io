...
- Про запук Redis в контейнері на соєму Laptop та приклади виконання простих команд
- Приклад простого Python Flask application що взаємодіє з Redis 
- Запуск на своєму laptop контейнеру redis  та контейнеру python сервісу з допомогою docker-composer

Демонстраційний приклад знаходиться в репозиторії за лінком [Flask app Rest API та взаємодія з Redis](https://github.com/pavlo-shcherbukha/py-flask-app-smpl-redis)

## <a name="p-2">2. Розгортання Redis локально в Docker контейнері</a>
...
## <a name="p3">3. Короткий довідник по командах Redis які можна виконати з допомогою redis-клієнта</a>
...
### <a name="p-3.1">3.1 [SET, GET, INCR]  Встановлення - читання ключа та його значення</a>
...
### <a name="p-3.3">3.3. [HSET, HGET, HDEL, HEXISTS]  Встановлення - читання hash-ключа</a>
...
### <a name="p-3.4">3.4. [DEL, EXISTS] Видалити ключ, перевірити навність ключа</a>
...
### <a name="p-3.5">3.5. Як зберегти JSON в Redis</a>

Допустимо у нас є JSON:

{ "title": "Second Attempt" ,  "author": "Oksana Zabuzhko", "published": 2005 }

то зберегти його можна звичайною командою **set**
...
### <a name="p-3.6">3.6. Корисні посилання по redis</a>
...
## <a name="p-4">4. Використання Redis сумісно з python flask application</a>
...
### <a name="p-4.1">Опис програмного коду демки</a>
...
### <a name="p-4.2">Підключення до redis</a>
...
### <a name="p-4.3">Проста функція лічилька кількості викликів АПІ</a>
...
### <a name="p-4.4">Розробка API методів, що дозволяюь створити ключ, прочитати занчення ключа, отримати список всіх ключів в Redis</a>
...
## <a name="p-5">Запуск та налаштування контейнерів</a> 
...
## <a name="p-6">Запуск контейнерів docker compose</a>
