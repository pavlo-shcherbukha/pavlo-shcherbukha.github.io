...
- 🐉 Мова ДРАКОН та пастка ДИПОЛя: 

Як радянські конструктори наступили на ті самі «табличні граблі» параметризації, на які сьогодні наступають розробники в Node-RED чи IBM ACE, і чому космос змусив їх створити візуальну мову програмування, що зараз рятує життя в європейській хірургії.

- 🛠️ «Виробниче пекло» та феритові кільця: 

Чому СРСР прорахував складну навігацію на цілих числах (Fixed-Point) без математичного копроцесора, і чому програму «Бурана» доводилося вручну «ткати» мідним дротом під мікроскопами.

- 🛰️ IBM AP-101 проти «Бисер-4»: 
Чому американський Шаттл вимагав пілотів для посадки, тоді як радянський софт діяв як автономний робот, що, самостійно перехитрив шторм на Байконурі.

-⚙️ Вплив на життя: 

Філософський погляд на те, чому титанічна праця над «Бисером» залишилася штучним пам'ятником, тоді як прості калькулятори МК-61 та народні клони ZX-Spectrum змінили життя цілого покоління.

Буде цікаво інженерам, архітекторам систем та всім, хто любить чесну історію технологій без пропагандистських міфів.
...
1. Архітектура та апаратна частина
...
2. Програмне забезпечення та мови розробки
...
3. Елементна база (мікросхеми K583 / K588)
...
4. БЦВК як системний комплекс та логіка резервування
...
Хоча, є один елемент яки можна порівнювати. А порівньвати можна  пам'ять.  Оперативна пам'ять в обох комп'ютерах була магнітна. На магнітних кільцях. Чому магнітна? Та тому що вона стійка до іонізуючого випромінення і енерго не залежна.  
В СРСР магнітна  пам'ять випускалася ще з другої половнни 1960х років і в не змінному вигляді дійшла до Бурана. Під неї випускалися зі спеціальних феритів кільця діаметром до 3 міліметрів і через ці кільця пропускалися тоненікі мідні дроти.  Модуль пам'яті був кубом зі стороною мабуть 20 сантимертів з якого з кожної сторни виходила купа контактів. Всі ці куби прошивалися вручну жінками під мікроскопами  (їх офіційно називали «прошивальниці»). Коли це оперативна пам'ять - це ще нічого. Там всі модулі стандартні. Але в "Бисер-4" і постійна пам'ять мікропрограм була зібрана  також намагнітній  пам'яті. А ось тут криється те саме технологічне пекло, тому що прошивка під програму не стандартна. Кожна зміна коду ДРАКОН чи ПРОЛ-2 для нової прошивки «Бисера» вимагала фізичного виготовлення нової металевої матриці та тижнів ручної праці «прошивальниць» під мікроскопом. Це пояснює, чому софт «Бурана» «заморозили» задовго до старту.
 
 В IBM AP-101 тільки оперативна пам'ять була мангітною. Прошивка там серійна типова, так вони ще і шилися машинами (станками). А постійна пам'ять була на 2 магнітних накопичувачах (грубо кажучи магнітофонах). Під час польоту Шаттла магнітофон (MMU) використовувався тільки як жорсткий диск для початкового завантаження чи зміни фаз пльоту. Сам процесор AP-101 не читав команди безпосередньо зі стрічки в реальному часі — він завантажував їх у феритову ОЗП, і вже з ОЗП виконував код.
...
- Прецизійні сендастові та феритові головки: Для високої щільності запису потрібен був мікроскопічний і стабільний зазор у головці (одиниці мікронів).
...
- Використовувався також у B‑52, F‑4 , в аеропортах та інших системах.


Якщо ж подумати про СРСР то до Буран з "Бисер-4" в космос літали: Суюзи, Протони, космічні станції МИР. Чому потрібно було робити нову систему з нуля?


Ось як виглядає еволюція радянських бортових ЕОМ виглядає  від «Аргонів» до БИСЕР‑4.
...
Ці машини Київського Інституту кібернетики були революцією. Мова «Аналитик» дозволяла комп'ютеру оперувати не просто числами, а аналітичними виразами (інтегралами, похідними). IBM пізніше викупила один екземпляр МІР-2, бо Глушков реалізував апаратну підтримку високорівневої мови на рівні мікрокоду швидше за американців! 

- Калькулятори серії Б-3-34, МК-54, МК-52, МК-61.

Хоч архітектурна ідея й була запозичена у калькуляторів HP (із їхньою зворотною польською нотацією), але реалізація була повністю на існуючих технологіях СРСР. Набір команд там явно наслідував великі ЕОМ (адресація точно від Assembler СМ 1420 / PDP-11). Тисячі школярів та студентів грали в ігри на цих калькуляторах, обраховували лабораторні роботи. Сотні радіоаматорів намагалися «хакнути» їх через клавіатуру чи сигнали індикаторів, шукаючи приховані регістри та недокументовані функції. СРСР тоді стояв за крок до винайдення власного аналога Arduino чи Raspberry. А мікросхему, на якій будувався цей калькулятор (серія К145), згодом «обрізали» і масово випускали для ширшого вжитку: у цифрових годинниках, магазинних вагах, контролерах управління перших радянських пральних машин «Вятка-автомат-16». Я вважаю, що це кращий вплив на людське житя.


- Поява в СРСР процесора Z80 та різних клонів  комп'ютера ZX-Spectrum на його основі.

В СРСР виник цілий рух тих, хто власноруч збирав «Спектруми» з розсипу мікросхем, писав ігри, грав у них, зламував софт чи вчився програмувати. На основі Z80 згодом випускалися й знамениті побутові АОН (автоматичні визначники номера). Особисто я зібрав 3 чи 4 екземпляри ZX-Spectrum. Мене неймовірно вразив асемблер Z80.
В цьому плані я людина балувана бо першим асемблер, який я вивчив був елегантний від PDP-11. Після нього асемблер від К580ВМ80 (Intel 8080) чи 8086 здавався якимсь сірим та неповним. А от Z80 зайшов одразу — своєю логікою, альтернативними регістрами та роботою з перериваннями. Ну і варто згадати, що попри купу проблем зі спеціалізованими магнітними накопичувачами в країні, ця манюня стійко і якісно зчитувала програми, записані на старі, потерті касети МК-60 з радянських магнітофонів 4-го класу, у яких і швидкість плавала, і частотна корекція працювала номінально, і головки стояли криво. Скільки людей завдяки цьому навчилися програмувати!